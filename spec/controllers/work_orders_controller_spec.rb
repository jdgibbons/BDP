  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved work_order as @work_order" do
        ...
        post :create, {:work_order => { "invoice_id" => "invalid value" }}, valid_session
        assigns(:work_order).should be_a_new(WorkOrder)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested work_order" do
        ...
        WorkOrder.any_instance.should_receive(:update).with({ "invoice_id" => "1" })
        put :update, {:id => work_order.to_param, :work_order => { "invoice_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the work_order as @work_order" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        WorkOrder.any_instance.stub(:save).and_return(false)
        put :update, {:id => work_order.to_param, :work_order => { "invoice_id" => "invalid value" }}, valid_session
        assigns(:work_order).should eq(work_order)
      end
