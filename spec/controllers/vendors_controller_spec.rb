  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved vendor as @vendor" do
        ...
        post :create, {:vendor => { "description" => "invalid value" }}, valid_session
        assigns(:vendor).should be_a_new(Vendor)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested vendor" do
        ...
        Vendor.any_instance.should_receive(:update).with({ "description" => "MyString" })
        put :update, {:id => vendor.to_param, :vendor => { "description" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the vendor as @vendor" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Vendor.any_instance.stub(:save).and_return(false)
        put :update, {:id => vendor.to_param, :vendor => { "description" => "invalid value" }}, valid_session
        assigns(:vendor).should eq(vendor)
      end
